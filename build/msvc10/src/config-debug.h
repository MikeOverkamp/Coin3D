...
#define COIN_INT16_T int16_t // modif FS

/* define this to a type of the indicated bitwidth */
//#define COIN_INT32_T int
#define COIN_INT32_T int32_t // modif FS

/* define this to a type of the indicated bitwidth */
//#define COIN_INT64_T long long
#define COIN_INT64_T int64_t  // modif FS

/* define this to a type of the indicated bitwidth */
//#define COIN_INT8_T char
#define COIN_INT8_T int8_t  // modif FS
...
#define COIN_UINT16_T uint16_t // modif FS

/* define this to a type of the indicated bitwidth */
//#define COIN_UINT32_T unsigned int
#define COIN_UINT32_T uint32_t // modif FS

/* define this to a type of the indicated bitwidth */
//#define COIN_UINT64_T unsigned long long
#define COIN_UINT64_T uint64_t // modif FS

/* define this to a type of the indicated bitwidth */
//#define COIN_UINT8_T unsigned char
#define COIN_UINT8_T uint8_t // modif FS
...
/* #undef HAVE_INT16_T */
#define HAVE_INT16_T 1 // modif FS

/* define this if the type is available on the system */
/* #undef HAVE_INT32_T */
#define HAVE_INT32_T 1 // modif FS

/* define this if the type is available on the system */
/* #undef HAVE_INT64_T */
#define HAVE_INT64_T 1 // modif FS

/* define this if the type is available on the system */
/* #undef HAVE_INT8_T */
#define HAVE_INT8_T 1 // modif FS
...
/* #undef HAVE_STDINT_H */
#define HAVE_STDINT_H 1 // modif FS
...
/* define this if the type is available on the system */
/* #undef HAVE_UINT16_T */
#define HAVE_UINT16_T 1 // modif FS

/* define this if the type is available on the system */
/* #undef HAVE_UINT32_T */
#define HAVE_UINT32_T 1 // modif FS

/* define this if the type is available on the system */
/* #undef HAVE_UINT64_T */
#define HAVE_UINT64_T 1 // modif FS

/* define this if the type is available on the system */
/* #undef HAVE_UINT8_T */
#define HAVE_UINT8_T 1 // modif FS
